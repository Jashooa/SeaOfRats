...
public:
	...
	struct FString                                     PropertyPath;                                             // 0x0090(0x0010) (ZeroConstructor)
...
public:
	...
	struct FString                                     TargetSequenceName;                                       // 0x00E0(0x0010) (Edit, ZeroConstructor)
...
{
public:
	struct FText                                       DisplayName;                                              // 0x0100(0x0018)
	unsigned char                                      UnknownData00[0x20];                                      // 0x0100(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
