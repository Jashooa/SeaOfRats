...
enum class EHealthChangedReason : uint8_t
{
	...
	EHealthChangedReason__Revive   = 48,
	EHealthChangedReason__MAX      = 49,
	EHealthChangedReason__EHealthChangedReason_MAX = 50
};
...
{
	ETeleportActionStateReason__Test = 0,
	ETeleportActionStateReason__LeaveConcealingObject = 1,
	ETeleportActionStateReason__TeleportPlayerToSafety = 2,
	ETeleportActionStateReason__SinkingShip = 3,
	ETeleportActionStateReason__Mermaid = 4,
	ETeleportActionStateReason__RespawnStatue = 5,
	ETeleportActionStateReason__ReturnToShip = 6,
	ETeleportActionStateReason__PanicTeleport_FoundAssociatedLocation = 7,
	ETeleportActionStateReason__PanicTeleport_NotFoundAssociatedLocation = 8,
	ETeleportActionStateReason__PanicTeleport_NoAssociatedLocationsProvided = 9,
	ETeleportActionStateReason__TeleportTriggerObject = 10,
	ETeleportActionStateReason__SentToBrig = 11,
	ETeleportActionStateReason__HideOutEntered = 12,
	ETeleportActionStateReason__HideOutLeftToSpecificExitPoint = 13,
	ETeleportActionStateReason__HideOutLeftWithNoExitPoint = 14,
	ETeleportActionStateReason__ContestTeleportPlayerToShipOnRestart = 15,
	ETeleportActionStateReason__ETeleportActionStateReason_MAX = 16
};
...
// Enum Athena.ECrewSpecificCutscenePriority
enum class ECrewSpecificCutscenePriority : uint8_t
{
	ECrewSpecificCutscenePriority__Low = 0,
	ECrewSpecificCutscenePriority__High = 1,
	ECrewSpecificCutscenePriority__Always = 2,
	ECrewSpecificCutscenePriority__Total = 3,
	ECrewSpecificCutscenePriority__ECrewSpecificCutscenePriority_MAX = 4
};
...
enum class EBootflowError : uint8_t
{
	...
	EBootflowError__LoginTokenExchangeFailed = 49,
	EBootflowError__LoginTokenExchangeFailedCannotRefreshExpiredToken = 50,
	...
	EBootflowError__LobbySesssionHandlerFailedToCreateLobbySession = 107,
	EBootflowError__LobbySesssionHandlerFailedToJoinLobbySession = 108,
	EBootflowError__LobbySessionHandlerJoinFailedAsUnknownErrorOccurred = 109,
	EBootflowError__LobbySessionHandlerJoinFailedAsCouldNotRetrieveAddress = 110,
	EBootflowError__LobbySessionHandlerJoinFailedAsSessionIsFull = 111,
	EBootflowError__LobbySessionHandlerJoinFailedAsSessionDoesntExist = 112,
	EBootflowError__LobbySessionInviteIsNotJoinable = 113,
	EBootflowError__CreatorModeSessionStateFailedToCreateLobbySession = 114,
	EBootflowError__CreatorModeSessionStateFailedToJoinLobbySession = 115,
	EBootflowError__CreatorModeSessionStateFailedToAdoptCrewSession = 116,
	EBootflowError__CreatorModeSessionStateFailedToLeaveLobbySession = 117,
	EBootflowError__CreatorModeSessionStateFailedToRegisterCrewsOnService = 118,
	EBootflowError__CreatorModeSessionStateFailedToReplicateCrewsFromService = 119,
	EBootflowError__TestFailed     = 120,
	EBootflowError__TestNetworkError = 121,
	EBootflowError__Max            = 122,
	EBootflowError__EBootflowError_MAX = 123
};
...
// Enum Athena.ECrewSessionQoSServerResolveResult
...
enum class ETrackedActorType : uint8_t
{
	...
	ETrackedActorType__Booty_ReapersChest = 20,
	ETrackedActorType__BuoyantActor = 21,
	ETrackedActorType__Consumable  = 22,
	ETrackedActorType__Earthquake  = 23,
	ETrackedActorType__FishingFish = 24,
	ETrackedActorType__FogBank     = 25,
	ETrackedActorType__Geyser      = 26,
	ETrackedActorType__Ghostship_Flameheart_Cloud = 27,
	ETrackedActorType__Mermaid     = 28,
	ETrackedActorType__NPC         = 29,
	ETrackedActorType__Player      = 30,
	ETrackedActorType__Rowboat     = 31,
	ETrackedActorType__Ship_Large  = 32,
	ETrackedActorType__Ship_Medium = 33,
	ETrackedActorType__Ship_Small  = 34,
	ETrackedActorType__ShipCloud   = 35,
	ETrackedActorType__Shipwreck   = 36,
	ETrackedActorType__ShortRangeMarker = 37,
	ETrackedActorType__SkeletonThrone = 38,
	ETrackedActorType__SkullCloud  = 39,
	ETrackedActorType__StorageContainer = 40,
	ETrackedActorType__StorageContainerBuoyant = 41,
	ETrackedActorType__Storm       = 42,
	ETrackedActorType__SunkenCurseArtefact = 43,
	ETrackedActorType__SuperHeatedWater = 44,
	ETrackedActorType__Volcano     = 45,
	ETrackedActorType__MAX         = 46,
	ETrackedActorType__ETrackedActorType_MAX = 47
};
...
enum class EEncounterActorRemovedReason : uint8_t
{
	...
	EEncounterActorRemovedReason__EEncounterActorRemovedReason_MAX = 2
};
...
enum class EQuestMapIcon : uint8_t
{
	...
	EQuestMapIcon__EQuestMapIcon_MAX = 9
};
...
enum class EAggressiveGhostShipTarget : uint8_t
{
	...
	EAggressiveGhostShipTarget__Anywhere = 5,
	EAggressiveGhostShipTarget__EAggressiveGhostShipTarget_MAX = 6
};
