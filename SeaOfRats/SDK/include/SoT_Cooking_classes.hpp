...
public:
	...
	struct FText                                       NotWieldingCookableItemTooltip;                           // 0x0460(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData02[0x20];                                      // 0x045C(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       WieldingCookableItemTooltip;                              // 0x0498(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData03[0x20];                                      // 0x0498(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       TakeItemTooltip;                                          // 0x04D0(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData04[0x20];                                      // 0x04D0(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       CannotTakeItemTooltip;                                    // 0x0508(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData05[0x20];                                      // 0x0508(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       MixInItemTooltip;                                         // 0x0540(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData06[0x20];                                      // 0x0540(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData07[0xA0];                                      // 0x0578(0x00A0) MISSED OFFSET
