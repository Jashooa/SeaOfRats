...
public:
	...
	struct FText                                       StartMaxRankQuestToolTipText;                             // 0x00D8(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData01[0x20];                                      // 0x00D1(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       CannotStartMaxRankQuestToolTipText;                       // 0x0110(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData02[0x20];                                      // 0x0110(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	struct FText                                       VoyageCinematicHeader;                                    // 0x0068(0x0018) (Edit, DisableEditOnInstance)
...
{
public:
	struct FText                                       EmissaryVotingCastVote;                                   // 0x00F8(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData00[0x20];                                      // 0x00F8(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       EmissaryVotingCantVote;                                   // 0x0130(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData01[0x20];                                      // 0x0130(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       EmissaryVotingCantVoteReasonCrewShipOutsideRange;         // 0x0168(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData02[0x20];                                      // 0x0168(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       EmissaryVotingCantVoteReasonNoEmissaryEntitlement;        // 0x01A0(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData03[0x20];                                      // 0x01A0(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       EmissaryVotingCantVoteReasonHasActiveVoteForDifferentCompany;// 0x01D8(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData04[0x20];                                      // 0x01D8(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       EmissaryVotingRemoveVote;                                 // 0x0210(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData05[0x20];                                      // 0x0210(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       EmissaryVotingCantRemoveVote;                             // 0x0248(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData06[0x20];                                      // 0x0248(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData07[0x18];                                      // 0x0280(0x0018) MISSED OFFSET
...
public:
	...
	struct FText                                       EmissaryVotingCantVoteReasonCrewShipOutsideRange;         // 0x0168(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData02[0x20];                                      // 0x0168(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       EmissaryVotingCantVoteReasonActiveForDifferentCompany;    // 0x01A0(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData03[0x20];                                      // 0x01A0(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       EmissaryVotingRemoveVote;                                 // 0x01D8(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData04[0x20];                                      // 0x01D8(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       EmissaryVotingCantRemoveVote;                             // 0x0210(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData05[0x20];                                      // 0x0210(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData06[0x18];                                      // 0x0248(0x0018) MISSED OFFSET
