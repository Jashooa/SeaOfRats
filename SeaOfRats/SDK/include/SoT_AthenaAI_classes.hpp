...
public:
	...
	struct FText                                       LocalisableName;                                          // 0x00A8(0x0018) (Edit)
	unsigned char                                      UnknownData00[0x20];                                      // 0x00A8(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	struct FString                                     Title;                                                    // 0x02D0(0x0010) (Net, ZeroConstructor)
	struct FText                                       DisplayNameAsText;                                        // 0x02E0(0x0018) (Net)
	unsigned char                                      UnknownData01[0x20];                                      // 0x02E0(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FString                                     DisplayNameAsString;                                      // 0x0318(0x0010) (Net, ZeroConstructor)
	struct FString                                     DebugDisplayText;                                         // 0x0328(0x0010) (Net, ZeroConstructor)
	bool                                               VisibilityDisabled;                                       // 0x0338(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xB7];                                      // 0x0339(0x00B7) MISSED OFFSET
...
{
public:
	struct FText                                       AIName;                                                   // 0x0028(0x0018) (Edit, DisableEditOnInstance)
...
public:
	...
	struct FText                                       DisplayName;                                              // 0x0838(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData01[0x20];                                      // 0x0830(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	struct FString                                     DefaultPetName;                                           // 0x03F0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
