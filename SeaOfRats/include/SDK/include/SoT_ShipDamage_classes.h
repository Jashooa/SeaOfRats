...
#include "SoT_ShipDamage_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class ShipDamage.DamageablePartsInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ShipDamage.HullDamageInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ShipDamage.LandscapeDamagerType"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ShipDamage.ShipDamagerType"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ShipDamage.StrainDamagerType"));
		return ptr;
	}
