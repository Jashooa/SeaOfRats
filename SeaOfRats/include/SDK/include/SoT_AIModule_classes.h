...
#include "SoT_AIModule_structs.h"
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AIModule.CustomDataProviderObject"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AIModule.AIDataProvider_QueryParamFromCustomObjectProperty"));
		return ptr;
	}
