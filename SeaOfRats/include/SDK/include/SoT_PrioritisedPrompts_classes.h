...
#include "SoT_PrioritisedPrompts_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class PrioritisedPrompts.BasePromptCoordinator"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PrioritisedPrompts.GetPromptsLocalService"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PrioritisedPrompts.PrioritisedPromptsManager"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PrioritisedPrompts.PromptCounterAccessKey"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PrioritisedPrompts.PromptsLocalServiceInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PrioritisedPrompts.PromptsLocalService"));
		return ptr;
	}
