...
#include "SoT_DebugMenu_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class DebugMenu.DebugMenuComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class DebugMenu.DebugMenuEntryGenerator"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class DebugMenu.DebugMenuDataAsset"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class DebugMenu.DebugMenu"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class DebugMenu.DebugMenuComponentMock"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class DebugMenu.DebugMenuTestFunctions"));
		return ptr;
	}
