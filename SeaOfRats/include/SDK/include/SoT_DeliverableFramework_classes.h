...
#include "SoT_DeliverableFramework_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class DeliverableFramework.DeliverableRequirementBase"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class DeliverableFramework.DeliverableInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class DeliverableFramework.DeliverableComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class DeliverableFramework.DeliverableRequirementsDataAsset"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class DeliverableFramework.DeliverableTooltipCustomizerInterface"));
		return ptr;
	}
