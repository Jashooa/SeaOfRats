...
#include "SoT_PositionalVoice_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class PositionalVoice.VoiceChatRendererInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PositionalVoice.MockVoiceChatRenderer"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PositionalVoice.VoiceChatRendererRetreivalInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PositionalVoice.MockVoiceChatRendererRetriever"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PositionalVoice.VoiceChatRenderer"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PositionalVoice.PositionalVoiceTestFunctionLibrary"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PositionalVoice.VoiceChatEmitterInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PositionalVoice.TestVoiceChatEmitter"));
		return ptr;
	}
