...
#include "SoT_AthenaServerMigration_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaServerMigration.MigrationServiceInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaServerMigration.ServerMigrationGatherableActorInterface"));
		return ptr;
	}
