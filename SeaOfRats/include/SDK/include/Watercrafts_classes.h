...
{
public:
	class UClass*                                      StorageInteractionInput;                                  // 0x0678(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UStorageContainerComponent*                  StorageContainerComponent;                                // 0x0680(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
