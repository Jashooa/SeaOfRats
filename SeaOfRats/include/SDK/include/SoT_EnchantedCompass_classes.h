...
#include "SoT_EnchantedCompass_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class EnchantedCompass.MultiTargetEnchantedCompass"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EnchantedCompass.TaleQuestSetCompassTargetToActorStep"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EnchantedCompass.TaleQuestSetCompassTargetToActorStepDesc"));
		return ptr;
	}
