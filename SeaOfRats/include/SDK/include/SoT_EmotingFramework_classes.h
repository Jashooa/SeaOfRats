...
#include "SoT_EmotingFramework_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class EmotingFramework.EmoteCard"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EmotingFramework.EmoteCoin"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EmotingFramework.EmoteIdListingAsset"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EmotingFramework.EmoteSettings"));
		return ptr;
	}
