...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class Repair.RepairTypeId"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Repair.RepairableInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Repair.RepairingInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Repair.WoodRepairTypeId"));
		return ptr;
	}
