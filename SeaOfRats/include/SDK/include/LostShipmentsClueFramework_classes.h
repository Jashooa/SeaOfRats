...
public:
	...
	class USeaClueSiteTypesDataAsset*                  SeaClueSiteTypes;                                         // 0x00A8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	TArray<class UClass*>                              AllowedClueTypes;                                         // 0x00C0(0x0010) (Edit, ZeroConstructor)
	class UClueConnectionConfig*                       ConnectionConfiguration;                                  // 0x00D0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UClueFactoryConfig*                          ClueFactoryConfiguration;                                 // 0x00A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FQuestVariableClueSite                      ClueSite;                                                 // 0x0090(0x0010) (Edit)
	class UClueFactoryConfig*                          ClueGenerationConfiguration;                              // 0x00A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UDebrisForVoyageRankDescAsset*               DebrisForRankDescAsset;                                   // 0x00A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class ULootForVoyageRankDescAsset*                 LootForRankDescAsset;                                     // 0x00A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UTaleQuestSelectClueSiteForLootStepDesc*     StepDesc;                                                 // 0x0090(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
