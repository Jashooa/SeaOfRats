...
#include "SoT_AthenaSocketLookup_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaSocketLookup.SocketIdTestFunctions"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaSocketLookup.SocketLookupCacheTestFunctions"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaSocketLookup.SocketLookupFunctions"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaSocketLookup.SocketLookupInterface"));
		return ptr;
	}
