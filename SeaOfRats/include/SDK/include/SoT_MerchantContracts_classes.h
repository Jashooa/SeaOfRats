...
#include "SoT_MerchantContracts_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class MerchantContracts.MerchantContractsBlueprintLibrary"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MerchantContracts.MerchantContractsServiceInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MerchantContracts.MerchantContractsService"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MerchantContracts.PlayerMerchantContractsInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MerchantContracts.PlayerMerchantContractsComponent"));
		return ptr;
	}
