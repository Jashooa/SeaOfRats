...
#include "SoT_RareEngine_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class RareEngine.RareGameEngine"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class RareEngine.AudioHardwareDeviceService"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class RareEngine.HitchDiagnosisBlueprintFunctionLibrary"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class RareEngine.MemoryUsageVisualiserSettings"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class RareEngine.RareHUD"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class RareEngine.StallDetector"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class RareEngine.StaticMeshActorBlueprintLibrary"));
		return ptr;
	}
