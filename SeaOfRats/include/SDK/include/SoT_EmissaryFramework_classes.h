...
#include "SoT_EmissaryFramework_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class EmissaryFramework.EmissaryLevelServiceInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EmissaryFramework.EmissaryParticipantInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EmissaryFramework.EmissaryVotingServiceInterface"));
		return ptr;
	}
