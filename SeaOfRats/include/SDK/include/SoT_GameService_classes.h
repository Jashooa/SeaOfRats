...
#include "SoT_GameService_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class GameService.ServiceProviderGameState"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class GameService.GameServiceLifecycleInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class GameService.GameServiceMapFunctions"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class GameService.GameServiceProviderInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class GameService.GameServiceTickInterface"));
		return ptr;
	}
