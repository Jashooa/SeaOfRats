...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class ObjectMessaging.ObjectMessagingDispatcherInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ObjectMessaging.ObjectMessagingDispatcherComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ObjectMessaging.ObjectMessagingInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ObjectMessaging.ObjectMessagingFunctions"));
		return ptr;
	}
