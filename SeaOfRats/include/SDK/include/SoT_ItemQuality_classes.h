...
#include "SoT_ItemQuality_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class ItemQuality.ItemQualityInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ItemQuality.ItemQualityComponent"));
		return ptr;
	}
