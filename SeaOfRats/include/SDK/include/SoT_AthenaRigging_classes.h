...
#include "SoT_AthenaRigging_structs.h"
...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaRigging.InstancedRopeComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaRigging.MaterialExpressionRopeParameter"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaRigging.RiggingSystem"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaRigging.RiggingSystemComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaRigging.RopeCatenaryRenderComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AthenaRigging.RopeInterface"));
		return ptr;
	}
